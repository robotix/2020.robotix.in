...
- Correctly detecting and displaying each of the numbers / characters present in the arena (Round 1 only): *+5*
- Bonus points for detecting all the numbers / characters: *+50*
- Correctly determining and displaying the expression according to the condition (Round 1 only) : *+100*
- Traversing correctly for every character according to the expression post correctly determining the expression: *+25*
- Traversing all the characters according to the expression (bonus) : *+50*
